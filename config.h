...
//static const char *discord[] = { "flatpak run com.discordapp.Discord", NULL };
//static const char *spotify[] = { "env LD_PRELOAD=/usr/local/lib/spotify-adblock.so spotify %U", NULL };
